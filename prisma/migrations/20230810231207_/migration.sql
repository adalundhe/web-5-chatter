...
CREATE TABLE "Account" (
    ...
    "id_token" TEXT,
    "session_state" TEXT,
    CONSTRAINT "Account_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("did") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Session" (
    ...
    CONSTRAINT "Session_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("did") ON DELETE CASCADE ON UPDATE CASCADE
);
